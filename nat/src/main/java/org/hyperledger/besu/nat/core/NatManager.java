...
/**
 * This class describes the behaviour of any supported NAT manager. Internal API
 * to support Network Address Translation (NAT) technologies in Besu.
 */
public interface NatManager {
  ...
  /**
   * Returns a {@link java.util.concurrent.Future} wrapping the local IP
   * address.
   *
   * @return The local IP address wrapped in a {@link
   *     java.util.concurrent.Future}.
   */
  CompletableFuture<String> queryLocalIPAddress();

  /**
   * Returns a {@link java.util.concurrent.Future} wrapping the external IP
   * address.
   *
   * @return The external IP address wrapped in a {@link
   *     java.util.concurrent.Future}.
   */
   ...
   */
  NatPortMapping getPortMapping(final NatServiceType serviceType,
