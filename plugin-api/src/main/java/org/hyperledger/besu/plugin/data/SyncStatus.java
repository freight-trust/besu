...
public interface SyncStatus {
  ...
  /**
   * PulledStates is the number of state entries fetched so far, or empty if
   * this is not known or not relevant.
   *
  ...
  /**
   * KnownStates is the number of states the node knows of so far, or empty if
   * this is not known or not relevant.
   *
