...
public class KeyPairSecurityModuleTest {
  ...
  @Test
  public void validatePublicKeyFromECPointCanBeConstructed()
      throws IOException {
    ...
    final KeyPairSecurityModule keyPairSecurityModule =
        new KeyPairSecurityModule(keyPair);
    ...
    final SECP256K1.PublicKey publicKey =
        SECP256K1.PublicKey.create(encodedBytes);
