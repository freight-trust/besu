...
public class ECPointUtilTest {
  ...
  public void ecPointWithBigIntegerByteArrayNot32ShouldBeEncoded() {
    final BigInteger xCoord =
        Bytes
            .fromHexString(
                "0x00c139989725b24ac6214f97d4ad75e74ddec4208ddc4a277195d95f7ca56735b6")
            .toBigInteger();
    final BigInteger yCoord =
        Bytes
            .fromHexString(
                "0x4b80989faae422b06a2a2fe75766402eb8e89b782bdb7c352c584cda8fd239")
            .toBigInteger();
    final Bytes expectedEncoded = Bytes.fromHexString(
  ...
  public void ecPointWithBigIntegerAs32ShouldBeEncoded() {
    final BigInteger xCoord =
        Bytes
            .fromHexString(
                "0x1575de790d7d00623a3f7e6ec2d0b69d65c5c183f8773a033d2c20dd20008271")
            .toBigInteger();
    final BigInteger yCoord =
        Bytes
            .fromHexString(
                "0x61772e076283d628beb591a23412c7d906d11b011ca66f188d4052db1e2ad615")
            .toBigInteger();
    final Bytes expectedEncoded = Bytes.fromHexString(
