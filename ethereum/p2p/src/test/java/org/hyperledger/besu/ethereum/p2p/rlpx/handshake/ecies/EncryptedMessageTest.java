...
public final class EncryptedMessageTest {
  ...
  public void eip8RoundTrip() throws InvalidCipherTextException {
    ...
    final Bytes encrypted =
        EncryptedMessage.encryptMsgEip8(initial, keyPair.getPublicKey());
    final Bytes decrypted = EncryptedMessage.decryptMsgEIP8(
        encrypted, NodeKeyUtils.createFrom(keyPair));
