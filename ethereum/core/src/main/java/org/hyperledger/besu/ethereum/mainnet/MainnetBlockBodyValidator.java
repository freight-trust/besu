...
public class MainnetBlockBodyValidator<C> implements BlockBodyValidator<C> {
  ...
  @Override
  public boolean validateBody(final ProtocolContext<C> context,
                              final Block block,
  ...
  @Override
  public boolean
  validateBodyLight(final ProtocolContext<C> context, final Block block,
                    final List<TransactionReceipt> receipts,
                    final HeaderValidationMode ommerValidationMode) {
  ...
  private boolean
  validateEthHash(final ProtocolContext<C> context, final Block block,
                  final HeaderValidationMode ommerValidationMode) {
    final BlockHeader header = block.getHeader();
    final BlockBody body = block.getBody();
  ...
  private boolean
  validateOmmers(final ProtocolContext<C> context, final BlockHeader header,
  ...
  private boolean isOmmerValid(final ProtocolContext<C> context,
  ...
  private boolean isOmmerSiblingOfAncestor(final ProtocolContext<C> context,
                                           final BlockHeader current,
                                           final BlockHeader ommer) {
