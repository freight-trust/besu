...
public enum AcceptedTransactionTypes {
  ...
  AcceptedTransactionTypes(final boolean isFrontierAccepted,
                           final boolean isEIP1559Accepted) {
    this.isFrontierAccepted = isFrontierAccepted;
    this.isEIP1559Accepted = isEIP1559Accepted;
  }

  public boolean isFrontierAccepted() { return isFrontierAccepted; }

  public boolean isEIP1559Accepted() { return isEIP1559Accepted; }

  @Override
  public String toString() {
    return String.format("frontier: %b / eip1559: %b", isFrontierAccepted,
                         isEIP1559Accepted);
  }
}
