...
public interface BlockProcessor {
  ...
  interface Result {
     ...
     *
     * <p>This is only valid when {@code BlockProcessor#isSuccessful} returns
     * {@code true}.
     *
     ...
     *
     * @return {@code true} if the block was processed successfully; otherwise
     *     {@code false}
     */
   ...
   */
  default Result processBlock(final Blockchain blockchain,
                              final MutableWorldState worldState,
                              final Block block) {
    return processBlock(blockchain, worldState, block.getHeader(),
   ...
   * @return the block processing result
   */
  Result processBlock(Blockchain blockchain, MutableWorldState worldState,
                      BlockHeader blockHeader, List<Transaction> transactions,
   ...
   * @return ommer reward
   */
  default Wei getOmmerReward(final Wei blockReward, final long blockNumber,
   ...
   */
  default Wei getCoinbaseReward(final Wei blockReward, final long blockNumber,
