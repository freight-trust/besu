 ...
 */
public class TimestampMoreRecentThanParent
  ...
  public TimestampMoreRecentThanParent(final long minimumSecondsSinceParent) {
    checkArgument(minimumSecondsSinceParent >= 0,
                  "minimumSecondsSinceParent must be positive");
  ...
  private boolean
  validateHeaderSufficientlyAheadOfParent(final long timestamp,
                                          final long parentTimestamp) {
