...
public interface Committer {
   ...
   */
  Tuple2<DamlLogEntry, java.util.Map<DamlStateKey, DamlStateValue>>
  processSubmission(Configuration defaultConfig, DamlLogEntryId entryId,
                    Timestamp recordTime, DamlSubmission submission,
