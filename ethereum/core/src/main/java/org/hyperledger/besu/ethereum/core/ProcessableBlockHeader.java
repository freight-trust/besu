...
public class ProcessableBlockHeader {
  ...
  protected ProcessableBlockHeader(final Hash parentHash,
                                   final Address coinbase,
                                   final Difficulty difficulty,
                                   final long number, final long gasLimit,
                                   final long timestamp, final Long baseFee) {
   ...
   */
  public Optional<Long> getBaseFee() { return Optional.ofNullable(baseFee); }
}
