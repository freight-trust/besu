...
public class PrivateTransactionValidator {
  ...
  validate(final PrivateTransaction transaction, final Long accountNonce,
    ...
    if (!signatureValidationResult.isValid()) {
      LOG.debug("Private Transaction failed signature validation {}, {}",
    ...
    LOG.debug("Validating actual nonce {}, with expected nonce {}",
  ...
  validatePrivateTransactionFields(
