...
public class PrunerConfiguration {
  ...
  public PrunerConfiguration(final int blockConfirmationsBeforeMarking,
                             final int blocksRetainedBeforeSweeping) {
  ...
  public static PrunerConfiguration getDefault() {
    return new PrunerConfiguration(DEFAULT_PRUNING_BLOCK_CONFIRMATIONS,
                                   DEFAULT_PRUNING_BLOCKS_RETAINED);
  }

  public int getBlocksRetained() { return blocksRetainedBeforeSweeping; }

  public int getBlockConfirmations() { return blockConfirmationsBeforeMarking; }
}
