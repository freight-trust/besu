...
public class VersionedPrivateTransaction {
  ...
  public VersionedPrivateTransaction(
    ...
    this(privateTransaction, result
                                 .map(value
                                      -> Bytes32.fromHexStringLenient(
                                          value.getOutput().toHexString()))
                                 .orElse(Bytes32.ZERO));
  }
  ...
  public static VersionedPrivateTransaction readFrom(final RLPInput input)
      throws RLPException {
    input.enterList();
    final PrivateTransaction privateTransaction =
  ...
  public Bytes32 getVersion() { return version; }
