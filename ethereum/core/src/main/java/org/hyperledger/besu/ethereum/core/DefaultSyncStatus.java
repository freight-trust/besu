...
public final class DefaultSyncStatus
    implements org.hyperledger.besu.plugin.data.SyncStatus {
  ...
  public DefaultSyncStatus(final long startingBlock, final long currentBlock,
  ...
  public boolean equals(final Object o) {
    ...
    return startingBlock == that.startingBlock &&
        currentBlock == that.currentBlock && highestBlock == that.highestBlock;
  }
