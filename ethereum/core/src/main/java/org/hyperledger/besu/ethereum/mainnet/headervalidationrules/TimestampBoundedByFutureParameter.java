...
/**
 * Responsible for ensuring the timestamp of a block is not more than
 * "acceptableClockDriftSeconds' into the future.
 */
public class TimestampBoundedByFutureParameter
  ...
  private boolean
  validateHeaderNotAheadOfCurrentSystemTime(final long timestamp) {
