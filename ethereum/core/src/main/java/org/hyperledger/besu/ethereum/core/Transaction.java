...
public class Transaction
  ...
  public static Transaction readFromExperimental(final RLPInput input)
      throws RLPException {
    input.enterList();
    ...
    if (input.isEndOfCurrentList()) {
      ...
      builder.gasPremium(Wei.of(maybeGasPremiumOrV.toBigInteger()))
   ...
   */
  public Transaction(final long nonce, final Wei gasPrice, final Wei gasPremium,
                     final Wei feeCap, final long gasLimit,
   ...
   * otherwise
   */
  public Transaction(final long nonce, final Wei gasPrice, final long gasLimit,
                     final Optional<Address> to, final Wei value,
                     final SECP256K1.Signature signature, final Bytes payload,
                     final Address sender, final Optional<BigInteger> chainId) {
    this(nonce, gasPrice, null, null, gasLimit, to, value, signature, payload,
         sender, chainId);
  }
  ...
  private Bytes32 getOrComputeSenderRecoveryHash() {
    if (hashNoSignature == null) {
      hashNoSignature = computeSenderRecoveryHash(
          nonce, gasPrice, gasPremium, feeCap, gasLimit, to.orElse(null), value,
          payload, chainId);
    }
  ...
  public void writeTo(final RLPOutput out) {
    ...
    final boolean asEIP1559 = ExperimentalEIPs.eip1559Enabled &&
                              (gasPrice == null || gasPrice.isZero()) &&
                              gasPremium != null && feeCap != null;
    if (asEIP1559) {
      out.writeNull();
    } else {
    ...
    if (ExperimentalEIPs.eip1559Enabled && gasPremium != null &&
        feeCap != null) {
   ...
   *     {@code false}
   */
  public boolean isContractCreation() { return getTo().isEmpty(); }
   ...
   */
  public Wei getUpfrontGasCost() { return getUpfrontGasCost(getGasPrice()); }
  ...
  public boolean isFrontierTransaction() {
    return getGasPrice() != null &&
        (getGasPremium().isEmpty() && getFeeCap().isEmpty());
  }
  ...
  private static Bytes32 computeSenderRecoveryHash(
      final long nonce, final Wei gasPrice, final Wei gasPremium,
      final Wei feeCap, final long gasLimit, final Address to, final Wei value,
      final Bytes payload, final Optional<BigInteger> chainId) {
  ...
  public boolean equals(final Object other) {
    ...
    return this.chainId.equals(that.chainId) &&
        ...
        Objects.equals(this.feeCap, that.feeCap) && this.nonce == that.nonce &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(nonce, gasPrice, gasPremium, feeCap, gasLimit, to,
                        value, payload, signature, chainId);
  }
  ...
  public static class Builder {
    ...
    public Transaction build() {
      return new Transaction(nonce, gasPrice, gasPremium, feeCap, gasLimit,
                             Optional.ofNullable(to), value, signature, payload,
                             sender, chainId);
    }
    ...
    SECP256K1.Signature computeSignature(final SECP256K1.KeyPair keys) {
      final Bytes32 hash =
          computeSenderRecoveryHash(nonce, gasPrice, gasPremium, feeCap,
                                    gasLimit, to, value, payload, chainId);
