...
public class BlockHeaderMock extends BlockHeader {
  ...
  public BlockHeaderMock(
    ...
    super(TestBlockchain.generateTestBlockHash(Long.decode(number) - 1),
          ...
          new LogsBloomFilter(), Difficulty.fromHexString(difficulty),
          Long.decode(number), Long.decode(gasLimit), 0L,
          Long.decode(timestamp), Bytes.EMPTY, 0L, Hash.ZERO, 0L,
