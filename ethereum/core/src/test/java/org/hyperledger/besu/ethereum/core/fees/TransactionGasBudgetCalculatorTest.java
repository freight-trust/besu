...
public class TransactionGasBudgetCalculatorTest {
  ...
  public TransactionGasBudgetCalculatorTest(
      ...
      final boolean isEIP1559, final long transactionGasLimit,
      final long blockNumber, final long blockHeaderGasLimit,
      final long gasUsed, final boolean expectedHasBudget) {
  ...
  public static Collection<Object[]> data() {
    return Arrays.asList(new Object[][] {
        ...
        {EIP1559_CALCULATOR, false, (FEE_MARKET.getMaxGas() / 2) + 1, 1L,
         FEE_MARKET.getMaxGas(), 0L, false},
        {EIP1559_CALCULATOR, false, (FEE_MARKET.getMaxGas() / 2) - 1,
         EIP_1559_FORK_BLOCK, 10L, 2L, false},
        {EIP1559_CALCULATOR, true, (FEE_MARKET.getMaxGas() / 2) + 1,
         EIP_1559_FORK_BLOCK, FEE_MARKET.getMaxGas(), 0L, false},
        {EIP1559_CALCULATOR, true, (FEE_MARKET.getMaxGas() / 2) - 1,
         EIP_1559_FORK_BLOCK, 10L, 2L, false},
        {EIP1559_CALCULATOR, true,
         (FEE_MARKET.getMaxGas() / 2) + FEE_MARKET.getGasIncrementAmount(),
         EIP_1559_FORK_BLOCK + 1, FEE_MARKET.getMaxGas(), 0L, true},
        {EIP1559_CALCULATOR, true,
         (FEE_MARKET.getMaxGas() / 2) + FEE_MARKET.getGasIncrementAmount() + 1,
         EIP_1559_FORK_BLOCK + 1, FEE_MARKET.getMaxGas(), 0L, false},
        {EIP1559_CALCULATOR, false,
         (FEE_MARKET.getMaxGas() / 2) - FEE_MARKET.getGasIncrementAmount(),
         EIP_1559_FORK_BLOCK + 1, FEE_MARKET.getMaxGas(), 0L, true},
        {EIP1559_CALCULATOR, false,
         (FEE_MARKET.getMaxGas() / 2) - FEE_MARKET.getGasIncrementAmount() + 1,
  ...
  public void assertThatCalculatorWorks() {
    assertThat(gasBudgetCalculator.hasBudget(
                   transaction(isEIP1559, transactionGasLimit),
                   blockHeader(blockNumber, blockHeaderGasLimit), gasUsed))
  ...
  private Transaction transaction(final boolean isEIP1559,
                                  final long gasLimit) {
