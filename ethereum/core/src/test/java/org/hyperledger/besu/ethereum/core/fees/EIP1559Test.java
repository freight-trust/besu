...
public class EIP1559Test {
  ...
  public void assertThatBaseFeeDecreasesWhenBelowTargetGasUsed() {
    assertThat(eip1559.computeBaseFee(feeMarket.getInitialBasefee(),
                                      feeMarket.getTargetGasUsed() - 1000000L))
  ...
  public void isValidBaseFee() {
    assertThat(
        eip1559.isValidBaseFee(feeMarket.getInitialBasefee(), 1012500000L))
        .isTrue();
  }
  ...
  public void isNotValidBaseFee() {
    assertThat(
        eip1559.isValidBaseFee(feeMarket.getInitialBasefee(),
                               feeMarket.getInitialBasefee() * 15L / 10L))
        .isFalse();
  }
  ...
  public void eip1559GasPool() {
    assertThat(eip1559.eip1559GasPool(FORK_BLOCK + 1))
        .isEqualTo((feeMarket.getMaxGas() / 2) +
                   feeMarket.getGasIncrementAmount());
    assertThat(eip1559.eip1559GasPool(FORK_BLOCK + 1) +
               eip1559.legacyGasPool(FORK_BLOCK + 1))
  ...
  public void givenBlockAfterEIPFinalized_whenIsEIP1559Finalized_returnsTrue() {
    assertThat(
        eip1559.isEIP1559Finalized(FORK_BLOCK + feeMarket.getDecayRange()))
        .isTrue();
  }

  @Test
  public void
  givenBlockBeforeEIPFinalized_whenIsEIP1559Finalized_returnsFalse() {
    assertThat(
        eip1559.isEIP1559Finalized(FORK_BLOCK + feeMarket.getDecayRange() - 1))
        .isFalse();
  }
  ...
  @Test
  public void
  givenValidLegacyTransaction_whenBeforeForkBlock_thenReturnsTrue() {
    assertThat(
        eip1559.isValidFormat(TransactionFixture.LEGACY, FRONTIER_TRANSACTIONS))
        .isTrue();
  }
  ...
  @Test
  public void
  givenValidLegacyTransaction_whenEIP1559Finalized_thenReturnsFalse() {
    assertThat(eip1559.isValidFormat(TransactionFixture.LEGACY,
  ...
  @Test
  public void
  givenValidEIP1559Transaction_whenAfterForkBlock_thenReturnsTrue() {
    assertThat(eip1559.isValidFormat(TransactionFixture.EIP1559,
                                     FEE_MARKET_TRANSITIONAL_TRANSACTIONS))
        .isTrue();
  }
  ...
  @Test
  public void
  givenValidEIP1559Transaction_whenEIP1559Finalized_thenReturnsTrue() {
    assertThat(eip1559.isValidFormat(TransactionFixture.EIP1559,
                                     FEE_MARKET_TRANSACTIONS))
        .isTrue();
  }
  ...
  private static class TransactionFixture {
    private static final Transaction LEGACY =
        Transaction.readFrom(RLP.input(Bytes.fromHexString(
