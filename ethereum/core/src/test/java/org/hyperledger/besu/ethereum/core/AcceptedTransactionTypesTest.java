...
public class AcceptedTransactionTypesTest {
  ...
  public void givenTransitional_isFrontierAcceptedReturnsTrue() {
    assertThat(FEE_MARKET_TRANSITIONAL_TRANSACTIONS.isFrontierAccepted())
        .isTrue();
  }

  @Test
  public void givenTransitional_isEIP1559AcceptedReturnsTrue() {
    assertThat(FEE_MARKET_TRANSITIONAL_TRANSACTIONS.isEIP1559Accepted())
        .isTrue();
  }
  ...
  public void testFrontierToString() {
    assertThat(FRONTIER_TRANSACTIONS.toString())
        .isEqualTo("frontier: true / eip1559: false");
  }
  ...
  public void testEIP1559OnlyToString() {
    assertThat(FEE_MARKET_TRANSACTIONS.toString())
        .isEqualTo("frontier: false / eip1559: true");
  }
}
