...
public class TransactionPriceCalculatorTest {
  ...
  public TransactionPriceCalculatorTest(
      ...
      final Wei gasPrice, final Wei gasPremium, final Wei feeCap,
      final Optional<Long> baseFee, final Wei expectedPrice) {
  ...
  public static Collection<Object[]> data() {
    return Arrays.asList(
        new Object[][] {// legacy transaction must return gas price
                        {FRONTIER_CALCULATOR, Wei.of(578L), null, null,
                         Optional.empty(), Wei.of(578L)},
                        // EIP-1559 must return gas premium + base fee
                        {EIP_1559_CALCULATOR, null, Wei.of(100L), Wei.of(300L),
                         Optional.of(150L), Wei.of(250L)},
                        // EIP-1559 must return fee cap
                        {EIP_1559_CALCULATOR, null, Wei.of(100L), Wei.of(300L),
                         Optional.of(250L), Wei.of(300L)}});
  }

  @Test
  public void assertThatCalculatorWorks() {
    assertThat(transactionPriceCalculator.price(Transaction.builder()
                                                    .gasPrice(gasPrice)
