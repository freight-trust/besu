...
public class CoinbaseFeePriceCalculatorTest {
  ...
  public CoinbaseFeePriceCalculatorTest(
      ...
      final Gas coinbaseFee, final Wei transactionGasPrice,
  ...
  public static Collection<Object[]> data() {
    return Arrays.asList(new Object[][] {
        ...
        {FRONTIER_CALCULATOR, Gas.of(100), Wei.of(10L), Optional.empty(),
         Wei.of(1000L)},
        // EIP-1559 must return gas * (gas price - base fee)
        {EIP_1559_CALCULATOR, Gas.of(100), Wei.of(10L), Optional.of(4L),
         Wei.of(600L)},
        // Negative transaction gas price case
        // {EIP_1559_CALCULATOR, Gas.of(100), Wei.of(95L), Optional.of(100L),
        // Wei.of(-500L)}
    });
  }
  ...
  public void assertThatCalculatorWorks() {
    assertThat(coinbaseFeePriceCalculator.price(coinbaseFee,
                                                transactionGasPrice, baseFee))
