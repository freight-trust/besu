...
public class TransactionEIP1559Test {
  private final RLPInput legacyRLPInput = RLP.input(Bytes.fromHexString(
  ...
  public void givenEIP1559Transaction_assertThatRlpDecodingWorks() {
    ...
    final Transaction eip1559Transaction = Transaction.readFrom(
        new BytesValueRLPInput(rlpOutput.encoded(), false));
  ...
  private void set(final Object object, final String fieldName,
