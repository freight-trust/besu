...
class LogFilter extends Filter {
  ...
  LogFilter(final String id, final BlockParameter fromBlock,
            final BlockParameter toBlock, final LogsQuery logsQuery) {
    super(id);
  ...
  public LogsQuery getLogsQuery() { return logsQuery; }

  void addLogs(final List<LogWithMetadata> logs) { this.logs.addAll(logs); }

  List<LogWithMetadata> logs() { return logs; }
