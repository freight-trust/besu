...
public class PrivGetLogs implements JsonRpcMethod {
  ...
  public JsonRpcResponse response(final JsonRpcRequestContext requestContext) {
    ...
    final FilterParameter filter =
        requestContext.getRequiredParameter(1, FilterParameter.class);

    checkIfPrivacyGroupMatchesAuthenticatedEnclaveKey(requestContext,
                                                      privacyGroupId);
    ...
    final List<LogWithMetadata> matchingLogs =
        filter.getBlockHash()
            .map(blockHash
                 -> privacyQueries.matchingLogs(privacyGroupId, blockHash,
                                                filter.getLogsQuery()))
            .orElseGet(() -> {
              ...
              return privacyQueries.matchingLogs(privacyGroupId,
