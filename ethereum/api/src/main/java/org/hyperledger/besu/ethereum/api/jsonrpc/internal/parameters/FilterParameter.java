...
public class FilterParameter {
  ...
  public Optional<Hash> getBlockHash() { return maybeBlockHash; }
  ...
  public boolean equals(final Object o) {
    ...
    return fromBlock.equals(that.fromBlock) && toBlock.equals(that.toBlock) &&
        addresses.equals(that.addresses) && topics.equals(that.topics) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(fromBlock, toBlock, addresses, topics, maybeBlockHash,
                        logsQuery);
  }
