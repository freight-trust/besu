...
public class SubscriptionRequestMapperTest {
  ...
  // These tests aren't passing through WebSocketRequestHandler, so connectionId
  // is null.
  ...
  public void mapRequestToUnsubscribeRequest() {
    final JsonRpcRequest jsonRpcRequest = parseWebSocketRpcRequest(
        "{\"id\": 1, \"method\": \"eth_unsubscribe\", \"params\": [\"0x1\"]}");
    final UnsubscribeRequest expectedUnsubscribeRequest =
        new UnsubscribeRequest(1L, CONNECTION_ID);
  ...
  public void mapRequestToUnsubscribeRequestMissingSubscriptionIdFails() {
    ...
    thrown.expectCause(
        both(hasMessage(
                 equalTo("Missing required json rpc parameter at index 0")))
  ...
  public void mapRequestToNewHeadsSubscribeIncludeTransactionsTrue() {
    ...
    final SubscribeRequest expectedSubscribeRequest = new SubscribeRequest(
  ...
  public void mapRequestToNewHeadsSubscribeIncludeTransactionsFalse() {
    ...
    final SubscribeRequest expectedSubscribeRequest = new SubscribeRequest(
        SubscriptionType.NEW_BLOCK_HEADERS, null, false, CONNECTION_ID);
  ...
  public void mapRequestWithSingleAddress() {
    ...
    final SubscribeRequest expectedSubscribeRequest = new SubscribeRequest(
        ...
        new FilterParameter(BlockParameter.LATEST, BlockParameter.LATEST,
                            singletonList(Address.fromHexString(
  ...
  public void mapRequestWithMultipleAddresses() {
    ...
    final SubscribeRequest expectedSubscribeRequest = new SubscribeRequest(
        ...
        new FilterParameter(
            ...
            Stream
                .of("0x8320fe7702b96808f7bbc0d4a888ed1468216cfd",
                    "0xf17f52151EbEF6C7334FAD080c5704D77216b732")
                .map(Address::fromHexString)
                .collect(toUnmodifiableList()),
            singletonList(singletonList(LogTopic.fromHexString(
  ...
  public void mapRequestToNewPendingTransactions() {
    ...
    final SubscribeRequest expectedSubscribeRequest = new SubscribeRequest(
        SubscriptionType.NEW_PENDING_TRANSACTIONS, null, false, CONNECTION_ID);
  ...
  public void mapRequestToSyncingSubscribe() {
    ...
    final SubscribeRequest expectedSubscribeRequest = new SubscribeRequest(
        SubscriptionType.SYNCING, null, false, CONNECTION_ID);
  ...
  public void mapRequestToSyncingSubscribeParsesSecondParam() {
    ...
    final SubscribeRequest expectedSubscribeRequest = new SubscribeRequest(
        SubscriptionType.SYNCING, null, true, CONNECTION_ID);
