...
public class AuthenticationServiceTest {
  ...
  @Test
  public void
  authenticationServiceNotCreatedWhenRpcAuthenticationDisabledAndHasCredentialsFile() {
  ...
  @Test
  public void
  authenticationServiceNotCreatedWhenRpcAuthenticationDisabledAndHasPublicKeyFile()
      throws IOException {
  ...
  @Test
  public void
  authenticationServiceNotCreatedWhenWsAuthenticationDisabledAndHasCredentialsFile() {
  ...
  @Test
  public void
  authenticationServiceNotCreatedWhenWsAuthenticationDisabledAndHasPublicKeyFile()
      throws IOException {
    final File publicKeyFile = File.createTempFile("publicKey", "jwt");
    final WebSocketConfiguration webSocketConfiguration =
        WebSocketConfiguration.createDefault();
