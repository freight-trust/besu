...
public class FilterParameterTest {
  ...
  @Test
  public void jsonWithArrayOfAddressesShouldSerializeSuccessfully()
      throws Exception {
    ...
    final JsonRpcRequestContext request = new JsonRpcRequestContext(
        readJsonAsJsonRpcRequest(jsonWithAddressArray));
    final FilterParameter expectedFilterParameter =
        filterParameterWithAddresses("0x0", "0x1");
  ...
  @Test
  public void jsonWithSingleAddressShouldSerializeSuccessfully()
      throws Exception {
    final String jsonWithSingleAddress =
        "{\"jsonrpc\":\"2.0\",\"method\":\"eth_getLogs\",\"params\":[{\"address\":\"0x0\"}],\"id\":1}";
    final JsonRpcRequestContext request = new JsonRpcRequestContext(
        readJsonAsJsonRpcRequest(jsonWithSingleAddress));
    final FilterParameter expectedFilterParameter =
        filterParameterWithAddresses("0x0");
  ...
  @Test
  public void jsonWithSingleAddressAndSingleTopicShouldSerializeSuccessfully()
      throws Exception {
    final String jsonWithSingleAddress =
  ...
  @Test
  public void
  jsonWithSingleAddressAndMultipleTopicsShouldSerializeSuccessfully()
      throws Exception {
    final String jsonWithSingleAddress =
        "{\"jsonrpc\":\"2.0\",\"method\":\"eth_getLogs\",\"params\":[{\"address\":\"0x0\", "
        + "\"topics\":[" + TOPICS_TWO_THREE_ARRAY + "]}],\"id\":1}";
  ...
  @Test
  public void
  jsonWithSingleAddressAndMultipleListsOfTopicsShouldSerializeSuccessfully()
      throws Exception {
    final String jsonWithSingleAddress =
        "{\"jsonrpc\":\"2.0\",\"method\":\"eth_getLogs\",\"params\":[{\"address\":\"0x0\", "
        + "\"topics\":[" + TOPICS_TWO_THREE_ARRAY + "," +
        TOPICS_TWO_THREE_ARRAY + "]}],\"id\":1}";
  ...
  @Test
  public void jsonWithFromAndToParametersDeserializesCorrectly()
      throws Exception {
    final String json =
    ...
    final JsonRpcRequestContext request =
        new JsonRpcRequestContext(readJsonAsJsonRpcRequest(json));
    final FilterParameter parsedFilterParameter =
        request.getRequiredParameter(0, FilterParameter.class);

    assertThat(parsedFilterParameter.getFromBlock())
        .isEqualTo(new BlockParameter(0));
    assertThat(parsedFilterParameter.getToBlock())
        .isEqualTo(BlockParameter.PENDING);
  }
  ...
  public void jsonWithBlockAndFromAndToParametersIsInvalid() throws Exception {
    final String json =
        ...
        "\"address\":\"0x0\", \"fromBlock\": \"0x0\", \"toBlock\": \"pending\","
        + "\"topics\":[" + TOPICS_TWO_THREE_ARRAY + "," +
        TOPICS_TWO_THREE_ARRAY + "], \"blockhash\": \"" + Hash.ZERO +
        "\"}],\"id\":1}";
  ...
  @Test
  public void
  jsonWithParamsInDifferentOrderShouldDeserializeIntoFilterParameterSuccessfully()
      throws Exception {
    ...
    assertThat(readJsonAsFilterParameter(jsonWithTopicsFirst))
        .isEqualToComparingFieldByFieldRecursively(
            readJsonAsFilterParameter(jsonWithTopicsLast));
  }

  @Test
  public void
  whenTopicsParameterIsArrayOfStringsFilterContainsListOfSingletonLists()
    ...
    assertThat(filter.getTopics())
        .containsExactly(
            singletonList(LogTopic.fromHexString(
                "0xce8688f853ffa65c042b72302433c25d7a230c322caba0901587534b6551091d")),
            singletonList(null),
            singletonList(LogTopic.fromHexString(
                "0x000000000000000000000000244a53ab66ea8901c25efc48c8ab84662643cc74")));
  ...
  @Test
  public void
  whenTopicsParameterContainsArraysFilterContainsListOfSingletonLists()
      throws JsonProcessingException {
  ...
  @Test
  public void emptyListAsSubTopicDecodesCorrectly()
      throws JsonProcessingException {
    final List<List<String>> topics = Lists.newArrayList(
        singletonList(
            "0xce8688f853ffa65c042b72302433c25d7a230c322caba0901587534b6551091d"),
  ...
  @Test
  public void emptyListOfTopicsInJsonShouldDeserializeAsEmptyList()
      throws java.io.IOException {
    final FilterParameter filterParameter =
        readJsonAsFilterParameter("{\"topics\":[]}");

    assertThat(filterParameter.getTopics().size()).isEqualTo(0);
  }

  @Test
  public void nestedEmptyListOfTopicsShouldDeserializeAsEmptyList()
      throws java.io.IOException {
    final FilterParameter filterParameter =
        readJsonAsFilterParameter("{\"topics\":[[]]}");
  ...
  @Test
  public void singleTopicShouldDeserializeAsSingleTopic()
      throws java.io.IOException {
    final FilterParameter filterParameter =
  ...
  @Test
  public void nestedSingleTopicShouldDeserializeAsSingleTopic()
      throws java.io.IOException {
    final FilterParameter filterParameter =
        readJsonAsFilterParameter("{\"topics\":[[\"" + TOPIC_TWO + "\"]]}");
  ...
  @Test
  public void twoTopicsShouldDeserializeAsTwoTopicLists()
      throws java.io.IOException {
  ...
  @Test
  public void twoTopicsInFirstPositionShouldDeserializeAsOneTopicList()
      throws java.io.IOException {
    final FilterParameter filterParameter = readJsonAsFilterParameter(
        "{\"topics\":[" + TOPICS_TWO_THREE_ARRAY + "]}");
    ...
    assertThat(filterParameter.getTopics())
        .containsExactly(List.of(LogTopic.fromHexString(TOPIC_TWO),
                                 LogTopic.fromHexString(TOPIC_THREE)));
  }

  @Test
  public void nullInFirstPositionShouldDeserializeAsEmptyFirstTopic()
      throws java.io.IOException {
    final FilterParameter filterParameter = readJsonAsFilterParameter(
  ...
  @Test
  public void
  twoTopicsInFirstAndSecondPositionShouldDeserializeAsTwoListsOfTopics()
      throws java.io.IOException {
    final FilterParameter filterParameter =
        readJsonAsFilterParameter("{\"topics\":[" + TOPICS_TWO_THREE_ARRAY +
                                  "," + TOPICS_FOUR_FIVE_ARRAY + "]}");

    assertThat(filterParameter.getTopics())
        .containsExactly(List.of(LogTopic.fromHexString(TOPIC_TWO),
                                 LogTopic.fromHexString(TOPIC_THREE)),
                         List.of(LogTopic.fromHexString(TOPIC_FOUR),
                                 LogTopic.fromHexString(TOPIC_FIVE)));
  }
  ...
  filterParameterWithAddresses(final String... addresses) {
    return new FilterParameter(BlockParameter.LATEST, BlockParameter.LATEST,
  ...
  private FilterParameter
  filterParameterWithSingleListOfTopics(final String... topics) {
    return new FilterParameter(
        BlockParameter.LATEST, BlockParameter.LATEST,
        singletonList(Address.fromHexString("0x0")),
        singletonList(Arrays.stream(topics)
  ...
  private FilterParameter
  filterParameterWithListOfTopics(final String... topics) {
    List<LogTopic> topicsList = Arrays.stream(topics)
                                    .map(LogTopic::fromHexString)
                                    .collect(toUnmodifiableList());
  ...
  readJsonAsJsonRpcRequest(final String jsonWithSingleAddress)
      throws java.io.IOException {
    return new ObjectMapper().readValue(jsonWithSingleAddress,
                                        JsonRpcRequest.class);
  }

  private FilterParameter readJsonAsFilterParameter(final String json)
      throws java.io.IOException {
    return new ObjectMapper().readValue(json, FilterParameter.class);
  }
}
