...
public final class NewPooledTransactionHashesMessage
  ...
  public static NewPooledTransactionHashesMessage
  create(final List<Hash> pendingTransactions) {
  ...
  public static NewPooledTransactionHashesMessage
  readFrom(final MessageData message) {
    ...
    if (code != MESSAGE_CODE) {
      throw new IllegalArgumentException(String.format(
          "Message has code %d and thus is not a NewPooledTransactionHashesMessage.",
          code));
    }
