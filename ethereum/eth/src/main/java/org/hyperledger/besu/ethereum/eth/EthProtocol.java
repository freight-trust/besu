...
public class EthProtocol implements SubProtocol {
  ...
  public static final Capability ETH62 =
      Capability.create(NAME, EthVersion.V62);
  public static final Capability ETH63 =
      Capability.create(NAME, EthVersion.V63);
  public static final Capability ETH64 =
      Capability.create(NAME, EthVersion.V64);
  public static final Capability ETH65 =
      Capability.create(NAME, EthVersion.V65);

  private static final EthProtocol INSTANCE = new EthProtocol();

  private static final List<Integer> eth62Messages = Arrays.asList(
      EthPV62.STATUS, EthPV62.NEW_BLOCK_HASHES, EthPV62.TRANSACTIONS,
      EthPV62.GET_BLOCK_HEADERS, EthPV62.BLOCK_HEADERS,
      EthPV62.GET_BLOCK_BODIES, EthPV62.BLOCK_BODIES, EthPV62.NEW_BLOCK);

  private static final List<Integer> eth63Messages =
      new ArrayList<>(eth62Messages);

  static {
    eth63Messages.addAll(Arrays.asList(EthPV63.GET_NODE_DATA, EthPV63.NODE_DATA,
                                       EthPV63.GET_RECEIPTS, EthPV63.RECEIPTS));
  }

  private static final List<Integer> eth65Messages =
      new ArrayList<>(eth63Messages);

  static {
    eth65Messages.addAll(Arrays.asList(EthPV65.NEW_POOLED_TRANSACTION_HASHES,
  ...
  public int messageSpace(final int protocolVersion) {
    ...
    case EthVersion.V64:
    case EthVersion.V65:
      // same number of messages in each range, eth65 defines messages in the
      // middle of the range defined by eth63 and eth64 defines no new ranges.
      return 17;
    default:
      return 0;
    }
  ...
  public static EthProtocol get() { return INSTANCE; }
