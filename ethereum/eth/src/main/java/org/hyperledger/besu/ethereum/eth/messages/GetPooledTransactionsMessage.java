...
public final class GetPooledTransactionsMessage extends AbstractMessageData {
  ...
  private GetPooledTransactionsMessage(final Bytes rlp) { super(rlp); }
  ...
  public static GetPooledTransactionsMessage
  create(final List<Hash> pooledTransactions) {
  ...
  readFrom(final MessageData message) {
    ...
    if (code != MESSAGE_CODE) {
      throw new IllegalArgumentException(String.format(
          "Message has code %d and thus is not a GetPooledTransactionsMessage.",
          code));
    }
