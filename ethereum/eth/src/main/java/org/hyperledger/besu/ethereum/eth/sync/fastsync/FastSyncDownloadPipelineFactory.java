...
public class FastSyncDownloadPipelineFactory<C>
  ...
  public FastSyncDownloadPipelineFactory(
      ...
      final ProtocolContext<C> protocolContext, final EthContext ethContext,
  ...
  createDownloadPipelineForSyncTarget(final SyncTarget target) {
    ...
    final DownloadHeadersStep<C> downloadHeadersStep =
        new DownloadHeadersStep<>(protocolSchedule, protocolContext, ethContext,
                                  detachedValidationPolicy, headerRequestSize,
                                  metricsSystem);
    ...
    final FastImportBlocksStep<C> importBlockStep = new FastImportBlocksStep<>(
