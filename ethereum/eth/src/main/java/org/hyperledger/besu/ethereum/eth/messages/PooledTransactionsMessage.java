...
public final class PooledTransactionsMessage extends AbstractMessageData {
  ...
  private PooledTransactionsMessage(final Bytes rlp) { super(rlp); }
  ...
  create(final List<Transaction> transactions) {
  ...
  public static PooledTransactionsMessage readFrom(final MessageData message) {
    ...
    if (code != MESSAGE_CODE) {
      throw new IllegalArgumentException(String.format(
          "Message has code %d and thus is not a PooledTransactionsMessage.",
          code));
    }
