...
public class FastSyncDownloaderTest {
  ...
  private final FastSyncActions<Void> fastSyncActions =
      mock(FastSyncActions.class);
  ...
  private final FastSyncDownloader<Void> downloader = new FastSyncDownloader<>(
  ...
  public void shouldResumeFastSync() {
    ...
    final FastSyncDownloader<Void> resumedDownloader = new FastSyncDownloader<>(
        fastSyncActions, worldStateDownloader, storage, taskCollection,
