...
public class BlockchainModule {
  ...
  @Singleton
  @Provides
  Blockchain provideBlockchain(@Named("GenesisBlock") final Block genesisBlock,
                               final BlockchainStorage blockchainStorage,
                               final MetricsSystem metricsSystem) {
    return DefaultBlockchain.createMutable(genesisBlock, blockchainStorage,
                                           metricsSystem);
  }
  ...
  @Provides
  WorldStateStorage
  provideWorldStateStorage(final KeyValueStorage keyValueStorage) {
    return new WorldStateKeyValueStorage(keyValueStorage);
  }

  @Provides
  WorldStatePreimageStorage
  provideWorldStatePreimageStorage(final KeyValueStorage keyValueStorage) {
