...
public class PrivateStaticFinalLoggersTest {
  ...
  public void setup() {
    compilationHelper = CompilationTestHelper.newInstance(
        PrivateStaticFinalLoggers.class, getClass());
  }

  @Test
  public void privateStaticFinalLoggersPositiveCases() {
    compilationHelper
        .addSourceFile("PrivateStaticFinalLoggersPositiveCases.java")
        .doTest();
  }
  ...
  public void privateStaticFinalLoggersNegativeCases() {
    compilationHelper
        .addSourceFile("PrivateStaticFinalLoggersNegativeCases.java")
        .doTest();
  }
}
