...
public abstract class BesuControllerBuilder<C> {
  ...
  public BesuControllerBuilder<C>
  ...
  public BesuController<C> build() {
    ...
    final boolean fastSyncEnabled =
        syncConfig.getSyncMode().equals(SyncMode.FAST);
  ...
  protected abstract MiningCoordinator createMiningCoordinator(
      ProtocolSchedule<C> protocolSchedule, ProtocolContext<C> protocolContext,
  ...
  createPeerValidators(final ProtocolSchedule<C> protocolSchedule) {
