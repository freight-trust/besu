...
public class EnvironmentVariableDefaultProviderTest {
  ...
  public void shouldReturnNullWhenEnvironmentVariableIsNotSet() {
    assertThat(
        provider.defaultValue(OptionSpec.builder("--no-env-var-set").build()))
        .isNull();
  }
  ...
  public void shouldReturnValueWhenEnvironmentVariableIsSet() {
    ...
    assertThat(
        provider.defaultValue(OptionSpec.builder("--env-var-set").build()))
        .isEqualTo("abc");
  }
  ...
  public void shouldReturnValueWhenEnvironmentVariableIsSetForAlternateName() {
    environment.put("BESU_ENV_VAR_SET", "abc");
    assertThat(provider.defaultValue(
                   OptionSpec.builder("--env-var", "--env-var-set").build()))
        .isEqualTo("abc");
  }

  @Test
  public void
  shouldReturnValueWhenEnvironmentVariableIsSetForAlternateNameAndLegacyPrefix() {
    environment.put("PANTHEON_ENV_VAR_SET", "abc");
    assertThat(provider.defaultValue(
                   OptionSpec.builder("--env-var", "--env-var-set").build()))
        .isEqualTo("abc");
  ...
  public void shouldNotReturnValueForShortOptions() {
    ...
    assertThat(provider.defaultValue(OptionSpec.builder("-h").build()))
        .isNull();
  }
