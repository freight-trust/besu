...
public class EthTransactions {
  ...
  public EthGetWorkTransaction getWork() { return new EthGetWorkTransaction(); }
  ...
  public EthGetBlockTransaction
  block(final DefaultBlockParameter blockParameter) {
  ...
  public EthGetBalanceAtBlockTransaction
  getBalanceAtBlock(final Account account, final BigInteger block) {
  ...
  getTransactionReceipt(final String transactionHash) {
    return new EthGetTransactionReceiptTransaction(transactionHash);
  }

  public EthSendRawTransactionTransaction
  sendRawTransaction(final String transactionData) {
    return new EthSendRawTransactionTransaction(transactionData);
  }

  public EthGetTransactionCountTransaction
  getTransactionCount(final String accountAddress) {
    return new EthGetTransactionCountTransaction(accountAddress);
  }

  public EthGetTransactionReceiptWithRevertReason
  getTransactionReceiptWithRevertReason(final String transactionHash) {
    return new EthGetTransactionReceiptWithRevertReason(transactionHash);
  }

  public EthMiningTransaction mining() { return new EthMiningTransaction(); }

  public EthNewPendingTransactionFilterTransaction
