...
public class Accounts {
  ...
  public Accounts(final EthTransactions eth) {
    this.eth = eth;
    richBenefactorOne = Account.fromPrivateKey(eth, "Rich Benefactor One",
                                               GENESIS_ACCOUNT_ONE_PRIVATE_KEY);
    richBenefactorTwo = Account.fromPrivateKey(
        eth, "Rich Benefactor Two",
        "c87509a1c067bbde78beb793e6fa76530b6382a4c0241e5e4a9ec0a0f44dc0d3");
  }

  public Account getSecondaryBenefactor() { return richBenefactorTwo; }

  public Account getPrimaryBenefactor() { return richBenefactorOne; }
