...
public class PrivConditions {
  ...
  public Condition
  getPrivacyPrecompileAddress(final Address precompileAddress) {
    return new PrivGetPrivacyPrecompileAddressSuccess(
        transactions.getPrivacyPrecompileAddress(), precompileAddress);
  }

  public Condition
  getPrivateTransaction(final Hash transactionHash,
  ...
  public Condition
  getPrivateTransactionReturnsNull(final Hash transactionHash) {
    return new PrivGetPrivateTransactionReturnsNull(
        transactions.getPrivateTransaction(transactionHash));
  }

  public Condition createPrivacyGroup(final List<String> addresses,
                                      final String groupName,
                                      final String groupDescription,
                                      final String groupId) {
    return new PrivCreatePrivacyGroupSuccess(
        transactions.createPrivacyGroup(addresses, groupName, groupDescription),
        groupId);
  }

  public Condition deletePrivacyGroup(final String groupId) {
    return new PrivDeletePrivacyGroupSuccess(
        transactions.deletePrivacyGroup(groupId), groupId);
  }

  public Condition findPrivacyGroup(final int numGroups,
                                    final String... groupMembers) {
    return new PrivFindPrivacyGroupSuccess(
        transactions.findPrivacyGroup(groupMembers), numGroups);
  }

  public Condition eeaSendRawTransaction(final String transaction) {
    return new EeaSendRawTransactionSuccess(
        transactions.sendRawTransaction(transaction));
  }

  public Condition distributeRawTransaction(final String transactionRLP,
  ...
  public Condition getTransactionCount(final String accountAddress,
  ...
  public Condition getEeaTransactionCount(final String accountAddress,
                                          final String privateFrom,
                                          final String[] privateFor,
                                          final int expectedTransactionCount) {
    return new PrivGetEeaTransactionCountSuccess(
        transactions.getEeaTransactionCount(accountAddress, privateFrom,
                                            privateFor),
        expectedTransactionCount);
  }
  ...
  public Condition multiTenancyValidationFail(final Transaction<?> transaction,
