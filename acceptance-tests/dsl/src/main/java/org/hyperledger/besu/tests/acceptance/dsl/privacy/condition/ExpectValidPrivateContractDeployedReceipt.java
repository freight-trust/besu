...
public class ExpectValidPrivateContractDeployedReceipt
    implements PrivateContractCondition {

  private final String contractAddress;
  private final String senderAddress;

  public ExpectValidPrivateContractDeployedReceipt(final String contractAddress,
  ...
  public void verify(final Contract contract) {
    ...
    // Address generation is deterministic, based on the sender address and the
    // transaction nonce
    assertThat(transactionReceipt.getContractAddress())
        .isEqualTo(contractAddress);

    // Address for the account that signed (and paid) for the contract
