...
public class PrivacyNodeConfiguration {
  ...
  PrivacyNodeConfiguration(final int privacyAddress,
  ...
  public int getPrivacyAddress() { return privacyAddress; }

  public boolean isOnchainPrivacyGroupEnabled() {
    return isOnchainPrivacyGroupEnabled;
  }

  public BesuNodeConfiguration getBesuConfig() { return besuConfig; }

  public OrionKeyConfiguration getOrionKeyConfig() { return orionConfig; }
}
