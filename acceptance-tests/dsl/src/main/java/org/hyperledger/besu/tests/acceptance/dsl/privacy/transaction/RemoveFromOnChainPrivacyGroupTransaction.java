...
public class RemoveFromOnChainPrivacyGroupTransaction
    implements Transaction<String> {
  private final Base64String privacyGroupId;
  private final PrivacyNode remover;
  private final String toRemove;

  public RemoveFromOnChainPrivacyGroupTransaction(final String privacyGroupId,
  ...
  public String execute(final NodeRequests node) {
    try {
      return node.privacy().privxRemoveFromPrivacyGroup(privacyGroupId, remover,
                                                        toRemove);
