...
public class PrivacyNodeFactory {
  ...
  public PrivacyNodeFactory(final Vertx vertx) { this.vertx = vertx; }

  private PrivacyNode create(final PrivacyNodeConfiguration privacyNodeConfig)
      throws IOException {
    return new PrivacyNode(privacyNodeConfig, vertx);
  }

  public PrivacyNode
  createPrivateTransactionEnabledMinerNode(final String name,
                                           final PrivacyAccount privacyAccount)
      throws IOException {
    return createPrivateTransactionEnabledMinerNode(name, privacyAccount,
                                                    Address.PRIVACY);
  }

  public PrivacyNode createPrivateTransactionEnabledMinerNode(
      final String name, final PrivacyAccount privacyAccount,
      final int privacyAddress) throws IOException {
    return create(new PrivacyNodeConfiguration(
        privacyAddress,
        new BesuNodeConfigurationBuilder()
            ...
            .build(),
        new OrionKeyConfiguration(privacyAccount.getEnclaveKeyPath(),
                                  privacyAccount.getEnclavePrivateKeyPath())));
  }

  public PrivacyNode
  createPrivateTransactionEnabledNode(final String name,
                                      final PrivacyAccount privacyAccount)
      throws IOException {
    return createPrivateTransactionEnabledNode(name, privacyAccount,
                                               Address.PRIVACY);
  }
  ...
  public PrivacyNode
  createIbft2NodePrivacyEnabled(final String name,
                                final PrivacyAccount privacyAccount)
      throws IOException {
