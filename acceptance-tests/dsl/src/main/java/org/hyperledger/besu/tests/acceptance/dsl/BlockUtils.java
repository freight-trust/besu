...
public class BlockUtils {
  ...
  createBlockHeader(final Block block,
                    final BlockHeaderFunctions blockHeaderFunctions) {
    final Hash mixHash = block.getMixHash() == null
    ...
    return new BlockHeader(
        ...
        block.getNumber().longValue(), block.getGasLimit().longValue(),
        block.getGasUsed().longValue(), block.getTimestamp().longValue(),
        Bytes.fromHexString(block.getExtraData()), null, mixHash,
        block.getNonce().longValue(), blockHeaderFunctions);
  }
}
