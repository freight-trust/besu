  ...
  */
  ...
  public void getLogsUsingBlockHashFilter() {
    ...
    */
    ...
    final LogFilterJsonParameter filter = blockHashLogFilter(
        blockHash, eventEmitterContract.getContractAddress());
  ...
  blockRangeLogFilter(final String fromBlock, final String toBlock,
    ...
    return new LogFilterJsonParameter(
        fromBlock, toBlock, List.of(contractAddress),
        List.of(List.of(EVENT_EMITTER_EVENT_TOPIC)), null);
  }

  private LogFilterJsonParameter
  blockHashLogFilter(final String blockHash, final String contractAddress) {
    return new LogFilterJsonParameter(
        null, null, List.of(contractAddress),
        List.of(List.of(EVENT_EMITTER_EVENT_TOPIC)), blockHash);
  }
