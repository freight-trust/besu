...
public interface GenesisConfigOptions {
  ...
  /**
   * Block number for the Dao Fork, this value is used to tell node to connect
   * with peer that did NOT accept the Dao Fork and instead continued as what is
   * now called the classic network
   *
  ...
  /**
   * Block number for ECIP-1015 fork on Classic network ECIP-1015: Long-term gas
   * cost changes for IO-heavy operations to mitigate transaction spam attacks
   * In reference to EIP-150 (ETH Tangerine Whistle) Note, this fork happens
   * after Homestead (Mainnet definition) and before DieHard fork
   *
   * @see <a
  ...
  /**
   * Block number for DieHard fork on Classic network The DieHard fork includes
   * changes to meet specification for ECIP-1010 and EIP-160 Note, this fork
   * happens after ECIP-1015 (classic tangerine whistle) and before Gotham fork
  ...
  /**
   * Block number for Gotham fork on Classic network, the Gotham form includes
   * changes to meet specification for ECIP-1017 and ECIP-1039 both regarding
   ...
   *     ECIP-1017: Monetary Policy and Final Modification to the Ethereum
  ...
  /**
   * Block number to remove difficulty bomb, to meet specification for
   * ECIP-1041.
   *
   * @see <a
  ...
  /**
   * Block number for Atlantis fork on Classic network Note, this fork happen
   * after Defuse Difficulty Bomb fork and before Agharta fork ECIP-1054:
   * Atlantis EVM and Protocol Upgrades Enable the outstanding Ethereum
   * Foundation Spurious Dragon and Byzantium network protocol upgrades for the
  ...
  /**
   * Block number for Agharta fork on Classic network. Enable the outstanding
   * Ethereum Foundation Constaninople and Petersburg network protocol upgrades
   * on the Ethereum Classic network in a hard-fork code-named Agharta to enable
  ...
  /**
   * Block number for Phoenix fork on Classic networks. Enable the outstanding
   * Ethereum Foundation Istanbul network protocol upgrades on the Ethereum
   * Classic network in a hard-fork code-named Phoenix to enable maximum
