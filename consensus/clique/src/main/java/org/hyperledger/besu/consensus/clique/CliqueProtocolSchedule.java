...
public class CliqueProtocolSchedule {
  ...
  public static ProtocolSchedule<CliqueContext>
  create(final GenesisConfigOptions config, final NodeKey nodeKey,
    ...
    return new ProtocolScheduleBuilder<>(
               ...
               -> applyCliqueSpecificModifications(
                   epochManager, cliqueConfig.getBlockPeriodSeconds(),
  ...
  private static ProtocolSpecBuilder<CliqueContext>
  applyCliqueSpecificModifications(
    ...
    return specBuilder
        .changeConsensusContextType(
            ...
            BlockHeaderValidationRulesetFactory.cliqueBlockHeaderValidator(
                secondsBetweenBlocks, epochManager),
            MainnetBlockBodyValidator::new, MainnetBlockValidator::new,
