...
/**
 * Represents the istanbul/64 protocol as used by Quorum (effectively an
 * extension of eth/63, which adds a single message type (0x11) to encapsulate
 * all communications required for IBFT block mining.
 */
public class Istanbul64Protocol implements SubProtocol {
  ...
  private static final List<Integer> istanbul64Messages = Arrays.asList(
      ...
      EthPV65.POOLED_TRANSACTIONS, EthPV63.GET_NODE_DATA, EthPV63.NODE_DATA,
      EthPV63.GET_RECEIPTS, EthPV63.RECEIPTS, INSTANBUL_MSG);
  ...
  public static Istanbul64Protocol get() { return INSTANCE; }
}
