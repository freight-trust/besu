...
public class OnChainPrivacyGroupManagementInterface extends Contract {
  ...
  @Deprecated
  protected OnChainPrivacyGroupManagementInterface(String contractAddress,
                                                   Web3j web3j,
  ...
  @Deprecated
  public static OnChainPrivacyGroupManagementInterface
  ...
  public static RemoteCall<OnChainPrivacyGroupManagementInterface>
  deploy(Web3j web3j, Credentials credentials,
         ContractGasProvider contractGasProvider) {
    return deployRemoteCall(OnChainPrivacyGroupManagementInterface.class, web3j,
